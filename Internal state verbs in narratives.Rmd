...
### narrative_genre*mental_state_category: Do children use different types of mental state verbs depending on the narrative context?
## random effects
...
# first center age around the mean, so that the intercept represents type/token ratio at th mean age and other factors are interpreted against the mean age
d$c_age <- d$age - mean(d$age)

m_lemma <- brm(lemma_mental_score|trials(total_words) ~
                     narrative_type*mental_state_category +
                     narrative_type*c_age + 
                     mental_state_category*c_age +
                     (1|id) + (1+mental_state_category|story),
         prior = c(prior(normal(0, 10), class = Intercept),
                prior(normal(0, 10), class = b)),
         data = d,
         family = binomial,
         chains = 4, cores = 4, iter = 8000)
saveRDS(m_lemma, "m_lemma.RDS")
...
# b_c_age_m_lemma <- arr_m_lemma[, "b_c_age"]
# b_narrative_genre1__m_lemma <- arr_m_lemma[, "b_narrative_genre1"]
...
# 
# b_narrative_genre1_mental_state_category1__m_lemma <- arr_m_lemma[,
# "b_narrative_genre1:mental_state_category1"]
# b_narrative_genre1_mental_state_category2__m_lemma <- arr_m_lemma[, "b_narrative_genre1:mental_state_category2"]
# b_narrative_genre1_mental_state_category3__m_lemma <- arr_m_lemma[, "b_narrative_genre1:mental_state_category3"]
# b_narrative_genre1_mental_state_category4__m_lemma <- arr_m_lemma[, "b_narrative_genre1:mental_state_category4"]
# 
# b_mental_state_category1_c_age__m_lemma <- arr_m_lemma[, "b_mental_state_category1:c_age"]
# b_mental_state_category2_c_age__m_lemma <- arr_m_lemma[, "b_mental_state_category2:c_age"]
# b_mental_state_category3_c_age__m_lemma <- arr_m_lemma[, "b_mental_state_category3:c_age"]
# b_mental_state_category4_c_age__m_lemma <- arr_m_lemma[, "b_mental_state_category4:c_age"]
# 
...
# b_narrative_genre1_mental_state_category5__m_lemma <- -(b_narrative_genre1_mental_state_category1__m_lemma + b_narrative_genre1_mental_state_category2__m_lemma + b_narrative_genre1_mental_state_category3__m_lemma + b_narrative_genre1_mental_state_category4__m_lemma)
# b_mental_state_category5_c_age__m_lemma <- -(b_mental_state_category1_c_age__m_lemma + b_mental_state_category2_c_age__m_lemma + b_mental_state_category3_c_age__m_lemma + b_mental_state_category4_c_age__m_lemma)
# 
...
# 
# est_b_narrative_genre1_mental_state_category5__m_lemma <- mean(b_narrative_genre1_mental_state_category5__m_lemma)
# ci_b_narrative_genre1_mental_state_category5__m_lemma <- quantile(b_narrative_genre1_mental_state_category5__m_lemma, c(0.025, 0.975))
# 
# est_b_mental_state_category5_c_age__m_lemma <- mean(b_mental_state_category5_c_age__m_lemma)
# ci_b_mental_state_category5_c_age__m_lemma <- quantile(b_mental_state_category5_c_age__m_lemma, c(0.025, 0.975))
# 
# # Print the results
...
#   narrative_genre1_mental_state_category5__m_lemma = list(estimate = est_b_narrative_genre1_mental_state_category5__m_lemma, CI = ci_b_narrative_genre1_mental_state_category5__m_lemma),
#   mental_state_category5_c_age__m_lemma = list(estimate = est_b_mental_state_category5_c_age__m_lemma, CI = ci_b_mental_state_category5_c_age__m_lemma))
# 
...
# m_token <- brm(total_mental_score|trials(total_words) ~
#                      narrative_type*mental_state_category +
#                      narrative_type*c_age + 
#                      mental_state_category*c_age + (1|id) + (1+mental_state_category|story),
#          prior = c(prior(normal(0, 10), class = Intercept),
#                 prior(normal(0, 10), class = b)),
#          data = d,
#          family = binomial,
...
# 
# b_narrative_genre1_mental_state_category1__m_token <- arr_m_token[,
# "b_narrative_genre1:mental_state_category1"]
# b_narrative_genre1_mental_state_category2__m_token <- arr_m_token[, "b_narrative_genre1:mental_state_category2"]
# b_narrative_genre1_mental_state_category3__m_token <- arr_m_token[, "b_narrative_genre1:mental_state_category3"]
# b_narrative_genre1_mental_state_category4__m_token <- arr_m_token[, "b_narrative_genre1:mental_state_category4"]
# 
# b_mental_state_category1_c_age__m_token <- arr_m_token[, "b_mental_state_category1:c_age"]
# b_mental_state_category2_c_age__m_token <- arr_m_token[, "b_mental_state_category2:c_age"]
# b_mental_state_category3_c_age__m_token <- arr_m_token[, "b_mental_state_category3:c_age"]
# b_mental_state_category4_c_age__m_token <- arr_m_token[, "b_mental_state_category4:c_age"]
# 
# # Calculate posterior samples for the missing levels
...
# b_narrative_genre1_mental_state_category5__m_token <- -(b_narrative_genre1_mental_state_category1__m_token + b_narrative_genre1_mental_state_category2__m_token + b_narrative_genre1_mental_state_category3__m_token + b_narrative_genre1_mental_state_category4__m_token)
# b_mental_state_category5_c_age__m_token <- -(b_mental_state_category1_c_age__m_token + b_mental_state_category2_c_age__m_token + b_mental_state_category3_c_age__m_token + b_mental_state_category4_c_age__m_token)
# 
# # Calculate estimates and credible intervals
...
# 
# est_b_narrative_genre1_mental_state_category5__m_token <- mean(b_narrative_genre1_mental_state_category5__m_token)
# ci_b_narrative_genre1_mental_state_category5__m_token <- quantile(b_narrative_genre1_mental_state_category5__m_token, c(0.025, 0.975))
# 
# est_b_mental_state_category5_c_age__m_token <- mean(b_mental_state_category5_c_age__m_token)
# ci_b_mental_state_category5_c_age__m_token <- quantile(b_mental_state_category5_c_age__m_token, c(0.025, 0.975))
# 
# # Print the results
...
#   narrative_genre1_mental_state_category5__m_token = list(estimate = est_b_narrative_genre1_mental_state_category5__m_token, CI = ci_b_narrative_genre1_mental_state_category5__m_token),
#   mental_state_category5_c_age__m_token = list(estimate = est_b_mental_state_category5_c_age__m_token, CI = ci_b_mental_state_category5_c_age__m_token))
# 
...
emm_lemma <- emmeans(m_lemma, ~ narrative_genre * mental_state_category, type = "response")
emm_token <- emmeans(m_token, ~ narrative_genre * mental_state_category, type = "response")
...
emm_df_lemma$narrative_genre <- recode(emm_df_lemma$narrative_genre,
                                      "MAIN" = "fictional",
                                      "GT"   = "personal")
emm_df_token$narrative_genre <- recode(emm_df_token$narrative_genre,
                                      "MAIN" = "fictional",
                                      "GT"   = "personal")

# Relevel so fictional is first, personal second
emm_df_lemma$narrative_genre <- fct_relevel(emm_df_lemma$narrative_genre,
                                           "fictional", "personal")
emm_df_token$narrative_genre <- fct_relevel(emm_df_token$narrative_genre,
                                           "fictional", "personal")
lemmas <- ggplot(emm_df_lemma, aes(x = narrative_genre, y = prob, color = mental_state_category, group = mental_state_category)) +
...
tokens <- ggplot(emm_df_token, aes(x = narrative_genre, y = prob, color = mental_state_category, group = mental_state_category)) +
  geom_point(position = position_dodge(width = 0.5)) +
  geom_line(position = position_dodge(width = 0.5)) +
  geom_errorbar(aes(ymin = lower.HPD, ymax = upper.HPD), width = 0.2, position = position_dodge(width = 0.5)) +
  labs(

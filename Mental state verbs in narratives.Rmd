...
# m_lemma <- brm(types_count|trials(total_words) ~ narrative_genre*mental_state_category + (1|id) + (1+mental_state_category|story),
...
# m_token <- brm(tokens_count|trials(total_words) ~ narrative_genre*mental_state_category + (1|id) + (1+mental_state_category|story),
#          prior = c(prior(normal(0, 10), class = Intercept),
#                 prior(normal(0, 10), class = b)),
#          data = d,
#          family = binomial,
